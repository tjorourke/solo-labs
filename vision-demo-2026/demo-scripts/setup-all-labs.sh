...
#
#   Clusters:
#     mesh1 + mesh2   Parts 1-4, 7 + Cost Management (this dir's setup.sh + agentregistry/setup-mesh1.sh + llm-gateway.sh)
...
[[ "${SKIP_AIGW:-false}"      == "true" ]] || { echo "==> AI gateway platform on mesh1 (Part 7)"; bash "$SCRIPT_DIR/llm-gateway.sh"; }

<a id="runbook--agentic-hitl-kind-live-demo"></a>
...
<a id="scene-1--read-only-no-hitl"></a>
...
<a id="scene-2--agent-hitl-fires-in-the-chat"></a>
...
<a id="scene-3--gateway-hitl-fires-in-the-platform-queue"></a>

...
#
# Requires ANTHROPIC_API_KEY in the environment (used by both the kagent
# default model config and the LangGraph BYO agent later). The chart default
# model under providers.anthropic is claude-haiku-4-5 — cheap + fast.
...
echo "  Next:      ./scripts/04-mcp-and-hitl.sh" >&2

...
const (
	issuer       = "agentic-loops-kind"
	signingKeyNS = "runaway-containment"
	jwksCM       = "jwt-jwks"
	tokenNS      = "runaway-containment"
	keyID        = "agentic-loops-key-1"
)

// One identity for the demo. The runaway-containment story isn't about
// identity — it's about per-session budgets. The inspector UI mounts this
// one JWT and uses it on every call.
...
func main() {
	...
	for _, id := range identities {
		...
		log.Printf("issued JWT for sub=%s", id.sub)
	}

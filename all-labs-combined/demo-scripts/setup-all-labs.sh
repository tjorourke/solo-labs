#!/usr/bin/env bash
# setup-all-labs.sh — stand up every cluster needed to run the 6-part demo suite.
#
#   Clusters:
#     mesh1 + mesh2   Parts 1-4 + Cost Management   (this dir's setup.sh + agentregistry/setup-mesh1.sh)

#!/usr/bin/env bash
# 03-apps.sh — deploy the echo app into both versioned app clusters, each with
# its own CLUSTER_VERSION baked in. Idempotent.
...
step "Deploying versioned echo apps"

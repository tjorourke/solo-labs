...
registry catalogue, publishes it, and deploys the *same* agent to two runtimes: Solo
...
## Prerequisites
- Docker running; an **Anthropic API key** and Solo licences (`SOLO_LICENSE_KEY` for kagent,

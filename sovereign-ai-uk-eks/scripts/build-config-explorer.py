...
GROUPS = [
    ...
    ("agentgateway", "agentgateway", [
        ...
        ("49-agent-model-access.yaml", "Internal door (agent → model)"),
    ...
    ("network", "Network (L4)", [
        ...
        ("93-registry-waypoint.yaml",    "Registry waypoint (L7, before the app)"),
        ("93-registry-readonly.yaml",    "Registry read-only (L7)"),
        ("94-artifactory-containment.yaml", "Artifactory contained at the mesh"),
        ("48-ambient-egress.yaml",       "Ambient egress (waypoint)"),

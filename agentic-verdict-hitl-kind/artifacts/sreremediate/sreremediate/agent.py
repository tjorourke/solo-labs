"""sreremediate — an ADK SRE assistant.
...
artifacts/sreremediate/sreremediate/agent.py, substituting only sreremediate.
...
os.environ.setdefault("OTEL_SERVICE_NAME", "sreremediate")

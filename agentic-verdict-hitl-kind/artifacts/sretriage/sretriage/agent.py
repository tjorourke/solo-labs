"""sretriage — an ADK SRE assistant.
...
artifacts/sreremediate/sreremediate/agent.py, substituting only sretriage.
...
os.environ.setdefault("OTEL_SERVICE_NAME", "sretriage")
